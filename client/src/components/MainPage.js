    ...
    <MDBRow className="no-gutters">
        ...
        <div className="rightside d-flex justify-content-center align-items-center"> 
                ...
                <MDBModal isOpen={modal} toggle={toggle} className="modal-visitor">
                                ...
                                <MDBModalBody>
                            Thank you for your visit. <br/><br/> If you don’t feel like creating an account, but still want to see the features, please use the login information below. <br /><br/> E-mail: visitor@fetchmate.com <br/> Password: 12345 <br/><br/> We hope you enjoy your visit.
                            </MDBModalBody>
                            <MDBModalFooter>
